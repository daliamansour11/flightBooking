...
abstract class AppLocalizations {
  ...
  /// No description provided for @econnomy.
  ///
  /// In en, this message translates to:
  /// **'ECONNOMY'**
  String get econnomy;
  ...
  /// No description provided for @availableflight.
  ///
  /// In en, this message translates to:
  /// **'Available Flight'**
  String get availableflight;
  ...
  /// No description provided for @bestvalueofferstoAsia.
  ///
  /// In en, this message translates to:
  /// **'Best Value Offers        to Asia!'**
  String get bestvalueofferstoAsia;
}
